 ...
 */
@ApiStatus.Internal
public final class DokkaCompactVirtualFileSet extends AbstractSet<VirtualFile> implements VirtualFileSetEx {
    ...
    @Deprecated
    @ApiStatus.Internal
    public DokkaCompactVirtualFileSet() {
    }
    ...
    @Deprecated
    @ApiStatus.Internal
    public DokkaCompactVirtualFileSet(@NotNull Collection<? extends VirtualFile> files) {
        addAll(files);
    }
    ...
    @Deprecated
    @ApiStatus.Internal
    public DokkaCompactVirtualFileSet(IntSet fileIds) {
        idSet = fileIds;
    ...
    public boolean retainAll(@NotNull Collection<?> c) {
        ...
        if (c instanceof DokkaCompactVirtualFileSet) {
            boolean modified = false;
            IntSet specifiedIdSet = ((DokkaCompactVirtualFileSet)c).idSet;
            BitSet specifiedFileIds = ((DokkaCompactVirtualFileSet)c).fileIds;
            Set<VirtualFile> specifiedWeirdFiles = ((DokkaCompactVirtualFileSet)c).weirdFiles;
    ...
    public boolean addAll(@NotNull Collection<? extends VirtualFile> c) {
        ...
        if (c instanceof DokkaCompactVirtualFileSet) {
            boolean modified = false;
            DokkaCompactVirtualFileSet setToAdd = (DokkaCompactVirtualFileSet)c;
